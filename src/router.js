...
export default new Router({
  ...
  routes: [
    ...
    },
    {
      path: '/add-deals',
      name: 'add-deals',
      component: () => import('./views/AddDeals.vue'),
    },
    {
      path: '/edit-deals/:id',
      name: 'edit-deals',
      component: () => import('./views/EditDeals.vue'),
    },
    {
      path: '/earn',
      name: 'earn',
    ...
    },
    {
      path: '/add-earn',
      name: 'add-earn',
      component: () => import('./views/AddEarn.vue'),
    },
    {
      path: '/edit-earn/:id',
      name: 'edit-earn',
      component: () => import('./views/EditEarn.vue'),
    },
    {
      path: '/loyalty',
      name: 'loyalty',
    ...
    },
    {
      path: '/add-loyalty',
      name: 'add-loyalty',
      component: () => import('./views/AddLoyalty.vue'),
    },
    {
      path: '/edit-loyalty/:id',
      name: 'edit-loyalty',
      component: () => import('./views/EditLoyalty.vue'),
    },
    {
      path: '/deal-of-the-month',
      name: 'deal-of-the-month',
      component: () => import('./views/DealOfTheMonth.vue'),
    },
    {
      path: '/add-deal-of-the-month',
      name: 'add-deal-of-the-month',
      component: () => import('./views/AddDealOfTheMonth.vue'),
    },
    {
      path: '/edit-deal-of-the-month/:id',
      name: 'edit-deal-of-the-month',
      component: () => import('./views/EditDealOfTheMonth.vue'),
    },
    {
      path: '/deal-of-the-week',
      name: 'deal-of-the-week',
      component: () => import('./views/DealOfTheWeek.vue'),
    },
    {
      path: '/add-deal-of-the-week',
      name: 'add-deal-of-the-week',
      component: () => import('./views/AddDealOfTheWeek.vue'),
    },
    {
      path: '/edit-deal-of-the-week/:id',
      name: 'edit-deal-of-the-week',
      component: () => import('./views/EditDealOfTheWeek.vue'),
    },
    {
      path: '/ecommerce',
      name: 'ecommerce',
