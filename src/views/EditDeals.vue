      ...
      <d-col lg="12" class="mx-auto mt-4">
        <d-card class="card-small edit-user-details mb-4">
          ...
          <d-card-footer class="border-top">
            <d-button size="sm" @click="editDeals" class="btn-accent ml-auto d-table mr-3">
              Submit
            </d-button>
          </d-card-footer>
...
export default {
  ...
  methods: {
    getOneDeal() {
      ...
      this.axios.get(address + ":3000/get-one-deal", {params: {id: id}, headers: headers.headers}).then((response) => {
