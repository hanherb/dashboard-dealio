...
export default {
  ...
  created: function()
  {
    this.fetchDealOfTheMonth();
  },

  methods: {
    fetchDealOfTheMonth() {
      this.axios.get(address + ":3000/get-deal-of-the-month", headers).then((response) => {
