      ...
      <d-col lg="12" class="mx-auto mt-4">
        <d-card class="card-small edit-user-details mb-4">
          ...
          <d-card-footer class="border-top">
            <d-button size="sm" @click="editLoyalty" class="btn-accent ml-auto d-table mr-3">
              Submit
            </d-button>
          </d-card-footer>
...
export default {
  ...
  methods: {
    getOneLoyalty() {
      ...
      this.axios.get(address + ":3000/get-one-loyalty", {params: {id: id}, headers: headers.headers}).then((response) => {
    ...
    editLoyalty() {
      ...
      this.axios.post(address + ':3000/edit-loyalty', postObj, headers)
      .then((response) => {
