      ...
      <d-col lg="12" class="mx-auto mt-4">
        <d-card class="card-small edit-user-details mb-4">
          ...
          <d-card-footer class="border-top">
            <d-button size="sm" @click="editDealOfTheMonth" class="btn-accent ml-auto d-table mr-3">
              Submit
            </d-button>
          </d-card-footer>
...
export default {
  ...
  methods: {
    getOneDeal() {
      ...
      this.axios.get(address + ":3000/get-one-deal-of-the-month", {params: {id: id}, headers: headers.headers}).then((response) => {
    ...
    editDealOfTheMonth() {
      ...
      this.axios.post(address + ':3000/edit-deal-of-the-month', postObj, headers)
      .then((response) => {
        if(response.status == 200) {
          this.$router.push('/deal-of-the-month');
        }
      });
    }
  }
