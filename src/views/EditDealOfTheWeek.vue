      ...
      <d-col lg="12" class="mx-auto mt-4">
        <d-card class="card-small edit-user-details mb-4">
                  ...
                  <d-form-row>
                    ...
                    <d-col md="8" class="form-group">
                      ...
                      <textarea v-model="input.description"
                        rows="8" wrap="soft" class="form-control form-control-lg">
                      </textarea>
                    </d-col>
                  </d-form-row>
                </d-col>
          ...
          <d-card-footer class="border-top">
            <d-button size="sm" @click="editDealOfTheWeek" class="btn-accent ml-auto d-table mr-3">
              Submit
            </d-button>
          </d-card-footer>
...
export default {
  ...
  methods: {
    getOneDeal() {
      ...
      this.axios.get(address + ":3000/get-one-deal-of-the-week", {params: {id: id}, headers: headers.headers}).then((response) => {
    ...
    editDealOfTheWeek() {
      ...
      this.axios.post(address + ':3000/edit-deal-of-the-week', postObj, headers)
      .then((response) => {
